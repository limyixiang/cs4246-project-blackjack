#!/usr/bin/env python3
"""Auto-generated script derived from hi_lo_variant/bet_sizing/sarsa.ipynb."""
...
def _dealer_tick_labels():
    return ['A'] + [str(i) for i in range(2, 11)]

def plot_q_bet_heatmap(agent, env, annotate=False, filename: str | None = None):
